...
| Export                                                                                                              | What                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Brand`, `readBrands(opts?)`, `resolveBrandRoot(brand, machine?, opts?)`, `brandFolderName(brand, machine?, opts?)` | Brands from `~/.config/appydave/brands.json` (registry only). A brand root rewrites any `/Users/<anyone>` prefix to this machine's home (A5); `machine.brandRoots[key]` overrides it. `brandFolderName` is the root's basename (`guy-monroe` → `v-guy`) |
