...
| `projectLayoutPaths(projectDir)`                                                                                                                                                                                                                                                                                                 | `{ layout: 'hub' \| 'legacy', recordings, transcripts }` — FliHub's folders under `hub/` (new projects) or at the top (legacy); `hub/` wins, never merged                                                                                                                                                                          |
