...
| Export                                                                             | What                                                                                                                                                                                                  |
| ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Brand`, `readBrands(opts?)`, `resolveBrandRoot(brand, machine?, opts?)`           | Brands from `~/.config/appydave/brands.json` (registry only). A brand root rewrites any `/Users/<anyone>` prefix to this machine's home (A5); `machine.brandRoots[key]` overrides it                  |
...
| `labPath({ brand, project, app, subject? }, machine?)`                             | `<labRoot>/v-<brand>/<code>-<project>/<app>/[<subject>/]`. Never touches the disk                                                                                                                     |
